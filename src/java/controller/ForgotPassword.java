...
public class ForgotPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (email == null) {
                dispatch(request, response, "view/common/authentication/forgot_password.jsp");
            } else {
                ...
                request.setAttribute("confirm", UserDAO.getInstance().getUser(email).getConfirmkey());
                dispatch(request, response, "view/common/authentication/sendOTP.jsp");
            }
        }
    }
