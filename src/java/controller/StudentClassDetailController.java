...
@WebServlet(name = "StudentClassDetailController", value = "/student/quizzes")
public class StudentClassDetailController extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Class targetClass = ClassDAO.getInstance().getClassFromId(classId);
        ...
        User teacher =  LectureDAO.getInstance().getLectureUserFromId(targetClass.getLectureId());
        ...
        dispatch(request,response,"/view/student/class/ClassPageStudent.jsp");
    }
