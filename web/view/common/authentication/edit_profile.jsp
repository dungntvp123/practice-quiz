                    ...
                    <div class="flex items-center justify-center p-12 sm:p-12 md:w-1/2 mx-auto"> <!-- Added 'mx-auto' class -->
                        <div class="w-full">
                            ...
                            <form action="editprofile" method="POST">
                                <div>
                                    <label class="block mt-4 text-sm">First Name</label>
                                    <input class="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
                                           placeholder="" type="text" name="firstname" id="first-name" oninput="validateFirstName()" value="<%=currentUser.getFirstname()%>">
                                    <p id="first-name-error" class="text-red-500 text-sm hidden"> First Name length must be in 1 - 30 characters and contain letters only</p>
                                </div>
                                <div>
                                    <label class="block mt-4 text-sm">Last Name</label>
                                    <input class="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
                                           placeholder="" type="text" name="lastname" id="last-name"
                                           oninput="validateLastName()" value="<%=currentUser.getLastname()%>"/>
                                    <p id="last-name-error" class="text-red-500 text-sm hidden">Last Name length must be in 1 - 30 characters and contain letters only</p>
                                </div>
                                <button class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue"
                                        id="update-button" type="submit" disabled>
                                    Update
                                </button>
                            </form>
