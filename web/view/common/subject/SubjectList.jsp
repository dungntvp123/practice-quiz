...
<%
    Vector<Subject> subjects = (Vector<Subject>) request.getAttribute("allSubject");
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 p-4">
                <a href="classes?subject=<%=s.getId()%>" class="block p-4 bg-white border border-gray-300 rounded shadow hover:bg-gray-100">
