...
<div class="flex flex-wrap place-items-start">
    <section class="relative mx-auto">
        <!-- navbar -->
        <nav class="flex justify-between bg-blue-300 text-white w-screen">
            <div class="px-5 xl:px-12 py-6 flex w-full h-20 items-center">
                <a class="text-3xl font-bold font-heading" href="${pageContext.request.contextPath}/mainpage">
                    <img class="h-12 w-15" src="${pageContext.request.contextPath}/img/Practice%20Quiz(3).png" alt="logo">

                </a>
                <!-- Nav Links -->
                <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                    <li><a class="hover:text-gray-200" href="${pageContext.request.contextPath}/mainpage">Home</a></li>
                            ...
                            <div @click="open = !open" class="  py-3"
                                ...
                                <div class="flex justify-center items-center space-x-3 cursor-pointer">
                                    <div class="w-12 h-12 rounded-full overflow-hidden border-2 dark:border-white border-gray-900">
                                        <img src="${pageContext.request.contextPath}/img/profile.jpg" alt="" class="w-full h-full object-cover">
                                    </div>
                                ...
                                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                    ...
                                    <ul class="space-y-3 dark:text-white">
                                        <li class="font-medium">
                                            <a href="${pageContext.request.contextPath}/ShowChangePassForLoggedUser?IdOfUser=<%=user.getId()%>" 
...
<script src="${pageContext.request.contextPath}/js/alpine.js"></script>